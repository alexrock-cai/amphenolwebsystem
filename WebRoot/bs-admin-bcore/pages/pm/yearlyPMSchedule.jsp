...
<head>
     <meta charset="UTF-8" />
    <title>Amphenol-GIS Web System | Yearly PM Page</title>
                ...
                <hr />
                  <div class="row">
                    <div class="col-lg-12">
            			...
            			<table id="grid-data-yearlyPM" class="table table-condensed table-hover table-striped" data-selection="true" data-multi-select="true" data-row-select="true" data-keep-selection="true" >
            				<thead>
            					<tr>
            						<th data-column-id="id" data-type="numeric" data-identifier="true">ID</th>
            						<th data-column-id="equipmentID" data-formatter="equipmentID" >设备编号</th>
            						<th data-column-id="year" >年度</th>
            						<th data-column-id="yearPMDay" data-formatter="yearPMDay">日期</th>
            						<th data-column-id="isYearPM" data-formatter="doPM">年度PM状态</th>
					...
					<!-- Form  Modal BEGIN  -->
						<div  class="col-lg-12">
						<form role="form" action="/pm/createYearlyPM" class="form-horizontal" id="newYearlyPMModal-validation" method="post">
                        <div class="modal fade " id="newYearlyPMModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="reset" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="H3">新建年度PM计划</h4>
...
<shiro:hasPermission name="pm:create">
	<script type="text/javascript">
		...
		function newYearlyBtn(){
			$("#grid-data-yearlyPM-header").find(".actionBar").prepend("<button id=\"new-yearlyPM\" class=\"btn btn-success\" data-toggle=\"modal\" data-target=\"#newYearlyPMModal\">New Schedule</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
    ...
    $(function () { 
    	...
    	$("#grid-data-yearlyPM").bootgrid({
    		...
    		$("#grid-data-yearlyPM").find(".command-edit").on("click",function(e){
    			
    		
    			$("#ajaxEditModal").load("/pm/getEditYearlyPMPage",
    					{
    						id:$(this).data("row-id")
    					},
    					function(data,status){
    						$(".pm-datepicker").datepicker({format:'mm-dd'});
    						//$("#year-picker").datepicker({format:'yy'});
    						$('#editYearlyPMModal').modal("show");
    					}
    			);
    			
    		}).end().find(".command-delete").on("click",function(e){
    			$.post("/pm/deleteYearlyPM",
    					{
    						id:$(this).data("row-id")
    					},
    					function(data,status){
    					...
    					$("#grid-data-yearlyPM").bootgrid('reload');
    		});
